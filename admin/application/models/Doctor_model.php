...
class Doctor_model extends CI_Model {
	...
	public function get_doctordetails(){
				    ...
				    $this->db->select('doctor.*,
			                  state_categories.state_name,
							  city_categories.city_name,
				              language_categories.language_name, 
				              country_categories.country_name,
 ...
 public function get_parent($id)
 {
	...
	function view_popup_doctor($id){
			//GROUP_CONCAT(specialty_categories.specialty_name ORDER BY specialty_categories.id) as specialty_name,
			//GROUP_CONCAT(language_categories.language_name ORDER BY language_categories.id) as language_name

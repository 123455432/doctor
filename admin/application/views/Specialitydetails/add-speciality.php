<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Add Visitaion Details
      </h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-crosshairs"></i>Home</a></li>
         <li><a href="#">Visitaion Details</a></li>
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Visitation Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                  ...
                  <div class="box-body">                 
                     <div class="col-md-12">
					      ...
					      <div class="form-group has-feedback">
                            <label for="exampleInputEmail1">Visitation Name</label>
					...
					<table id="" class="table table-bordered table-striped datatable">
                     <thead>
                        <tr>
						   ...
						   <th>Reason</th>
                           <th>Visitation Name</th>
                           <th>Action</th>
                        </tr>
                     </thead>
                     <tbody>
                        <?php
                           foreach($data as $spelity) {			 
                           ?>
                        <tr>
                           ...
                           <td class="center">	
							  ...
							  <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Speciality_ctrl/edit_speialityval/<?php echo $spelity->id; ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
							  
							   <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Speciality_ctrl/delete_speciality/<?php echo $spelity->id; ?>" onClick="return doconfirm()">

   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">View Doctor Details</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-xs-12">
			...
			?></span> 				                                                                                            
                           <td class="center">	                         
                              ...
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Doctor_ctrl/edit_doctorformation/<?php echo $doctors->id; ?>">
...
<div class="modal fade modal-wide" id="popup-doctorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
   aria-hidden="true">

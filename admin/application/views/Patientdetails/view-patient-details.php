                  ...
                  <table class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="center"><?php echo $patient->terms; ?></td> 
                           ...
                           <td class="center">	                         
                              ...
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Patient_details/edit_patient/<?php echo $patient->id; ?>">
...
<div class="modal fade modal-wide" id="popup-patientModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
   aria-hidden="true">

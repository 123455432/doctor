               ...
               <form role="form" action="" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">		
                  <div class="box-body">                 
					 ...
					 <input type="hidden" name="status" value="1" >
						 ...
						 <div class="form-group has-feedback">
								...
								<input type="text" class="form-control required" name="dob" id="datepicker" placeholder="dob"  required ="">
								<span class="glyphicon  form-control-feedback"></span>
					     </div>		
						   
						<div class="form-group has-feedback">
					    <label for="exampleInputEmail1">PhoneNumber</label>
					    <input type="text" class="form-control required" name="phone" data-parsley-trigger="keyup" data-parsley-type="digits" data-parsley-minlength="10" data-parsley-maxlength="15" data-parsley-pattern="^[0-9]+$" required="" placeholder="phone">
					    <span class="glyphicon  form-control-feedback"></span>
					    </div>
                        ...
                        <span class="glyphicon  form-control-feedback"></span>
						   ...
						   <input type="text" id="Inputcountry" class="form-control required" name="country"  placeholder="country" autocomplete="on" onClick="initializecountry(this.id);">
						   <span class="glyphicon  form-control-feedback"></span>
						   </div>	
						 
						   <div class="form-group has-feedback">
						   <label for="exampleInputEmail1">State</label>
						   <input type="text" id="Inputstate" class="form-control required" name="state"  placeholder="state" autocomplete="on" onClick="initializestate(this.id);">
						   <span class="glyphicon  form-control-feedback"></span>
						   </div>	
						
						   <div class="form-group has-feedback">
						   <label for="exampleInputEmail1">City</label>
						   <input type="text" id="Inputcity" class="form-control required" name="city"  placeholder="City" autocomplete="on" onClick="initialize(this.id);">
						   <span class="glyphicon  form-control-feedback"></span>
						   </div>	
                  ...
                  <div class="box-footer">
				   ...
				   <div class="col-md-6">
						   ...
						   data-parsley-minlength="6" data-parsley-maxlength="15" required="" placeholder="Password">
						   <span class="glyphicon  form-control-feedback"></span>
						   </div>
					   ...
					   <select class="form-control select2 js-example-basic-multiple"  multiple="multiple" style="width: 100%;" name="insurance[]" id="insurance_name" required="">
					    ...
					    echo 'selected';  ?> ><?php echo $insudetailsval->insurance_name;?></option>			  
						   ...
						   <input name="patient_display_image" accept="image/*" type="file" required="">

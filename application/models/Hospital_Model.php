...
class Hospital_Model extends CI_Model
	...
	function _construct()
		...
		public function getall_hospitalfiltermap($data){
	   ...
	   $this->db->where("(hos.trial_date >='$currentDate' OR hos.end_date >='$currentDate')");		
		...
		public function getall_hospitalconven($data)
          {					
...
public function get_singlehospital($id){
		...
		public function get_latlang_hospital($id){
			
			$this->db->select('display_image,hospital_name,latitude,longitude');
			$this->db->from('hospital');
			$this->db->where('id', $id);
			$query = $this -> db -> get();
			return $query->row();
		}
		public function get_hospitaldoctors($id){
	   ...
	   $this->db->where("(do.trial_date >='$currentDate' OR do.end_date >='$currentDate')");
		...
		public function get_singlehospitalgallery($id){

...
public function get_singlemedical($id){
			
			$this->db->select('med.id as id,med.about_medical,med.amenities,med.medical_affilliations,med.medical_name,med.email,med.medical_languages,med.visitation,med.insurance,med.medical_awards,med.medical_memberships,med.medical_country,med.password,med.medical_address,med.medical_state,med.medical_city,med.medical_zip,med.specialty,med.terms,med.status,med.display_image,
		rate.review,rate.date,rate.medical_id,rate.patient_id,rate.rating,AVG(rate.rating) as avg_rating,cou.country_name,stat.state_name,cit.city_name,
		...
		public function get_latlang_medical($id){
		...
		public function get_medicaldoctors($id){
	   ...
	   $this->db->where("(do.trial_date >='$currentDate' OR do.end_date >='$currentDate')");
		...
		public function get_singlemedicalgallery($id){

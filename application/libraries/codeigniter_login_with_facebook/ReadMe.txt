...
3. Open the "application/controller/User_authentication.php" file and change the $appId, $appSecret, and $redirectUrl variable value according to your Facebook App credentials.
4. Open the URL (http://localhost/project_folder_name/user_authentication) on the browser and test the login with Facebook.

                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="sel-clinic-group">							
                                <img src= "<?php echo $view_medical->display_image;?>" alt="" class="img-responsive sel-log-img"/>
                                <p><?php echo $view_medical->medical_address; ?>, <?php echo $view_medical->city_name;?>
                                   <?php echo $view_medical->state_name;?>,<?php echo $view_medical->country_name;?> <?php echo $view_medical->medical_zip;?>
                                </p>
                                <h4>Rate Us</h4>
                                    ...
                                    <div class="manage-ad-inner-main tab-manage-1">
                                     <div class="image-large-gallery">
									  ...
									  <?php if(!empty ($view_medicalgallery[0])){ ?>
                                          <img src= "<?php echo $view_medicalgallery[0]->image;?>" id="DataDisplay" class="img-responsive" />
										  <?php }else{ ?>
                                                     ...
                                                     <div class="carousel-inner onebyone-carosel">
                                                         <div class="item active">
															 ...
															 <?php if(!empty ($view_medicalgallery[1])){ ?>
                                                              <img src= "<?php echo $view_medicalgallery[1]->image;?>" />
															   <?php }else{ ?>
									  ...
									  <?php }?>
                                                         ...
                                                         <div class="item ">
															 ...
															 <?php if(!empty ($view_medicalgallery[2])){ ?>
                                                                 <img src= "<?php echo $view_medicalgallery[2]->image;?>" />
																  <?php }else{ ?>
										   <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_medicalgallery[3])){ ?>
                                                                 <img src= "<?php echo $view_medicalgallery[3]->image;?>" />
																  <?php }else{ ?>
										   <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_medicalgallery[4])){ ?>
                                                                 <img src= "<?php echo $view_medicalgallery[4]->image;?>" />
																  <?php }else{ ?>
										   <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_medicalgallery[5])){ ?>
                                                                 <img src= "<?php echo $view_medicalgallery[5]->image;?>" />
																  <?php }else{ ?>
										   <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_medicalgallery[6])){ ?>
                                                                 <img src= "<?php echo $view_medicalgallery[6]->image;?>" />
																  <?php }else{ ?>
										   <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
    ...
    <div class="modal fade bac-modal" id="myModalbook-app" role="dialog">
        ...
        <div class="view-more loadmore">
		 <div id="moremedicaldoctor<?php echo $doctor_detail->id; ?>" class="moreboxmedicaldoctor">
            ...
            <a href="#" id="<?php  echo $doctor_detail->id; ?>" class="filterloadmoremedicaldoctor" ><h3><span><img src="<?php echo base_url(); ?>assets/images/patient-login/vmore.png" /> </span><?php if($lgfncountry){ echo $lgfncountry; }else { ?>View More<?php } ?></h3></a>
        </div>
    </div>
		 <?php } ?>

...
<?php $hos_id=$this->session->userdata['frontend_logged_in']['id']; ?>
        ...
        <div class="sel-clinic-main">
                ...
                <div class="col-lg-12 ">
					...
					<h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2><?php if($lghosmod102){ echo $lghosmod102; }else { ?> You are using 15 days free trial version.Once the trial period is expired , your hospital listing will be removed from Search Filter. Select any package to extend your service under Bookmydoc.<?php } ?>
								</h2>
					</div>
					...
					<button class="close" data-dismiss="alert" type="button">×</button>
					<h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2>  <?php if($lghosmod103){ echo $lghosmod103; }else { ?>Your Package period is expired . Kindly Select any package to list your hospital under Bookmydoc.<?php } ?>
								</h2>
					</div>
			...
			<?php if ($profile_status != "1" AND $features_status  != "1" ){ ?>
					...
					<button class="close" data-dismiss="alert" type="button">×</button>
								 <h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2> <?php if($lghosmod105){ echo $lghosmod105; }else { ?>Your hospital will found once if you complete the required details for profile settings and features.So please add it & list your hospital under BOOKMYDOC.<?php } ?>
								</h2></div>
                                        </div>
								<?php } ?>
                                        <div class="head-my-listing">
                                            <h3><?php if($lghosmod11){ echo $lghosmod11; }else { ?>Hospitals under <?php } ?><?php echo $username; ?></h3>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-2 evt-br-1 view-cln-1">
                                                    <div class="view-clinic view-dash-mn">
                                                        <a href="javascript:void(0);" id="<?php echo $mysubhosp->id;?>" class="hospitaljuncdoctoranother" ><h5><span><i class="fa fa-pencil"></i> </span><?php if($lghosmod14){ echo $lghosmod14; }else { ?>Edit<?php } ?></h5></a>
                                                        <h5><?php if($lghosmod15){ echo $lghosmod15; }else { ?>Published<?php } ?></h5>
                                                        <h5><?php if($lghosmod16){ echo $lghosmod16; }else { ?>Hits - 0<?php } ?></h5>
                                                        <h6><a href="javascript:void(0);" id="<?php echo $mysubhosp->id;?>" class="hospitaljuncdoctoranotherdelete" ><?php if($lghosmod17){ echo $lghosmod17; }else { ?> Remove<?php } ?></a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                         <?php } ?>  
                                  ...
                                  <?php  }   ?>
                                    ...
                                    <div class="manage-ad-inner-main tab-manage-2">
                                            ...
                                            <ul class="nav nav-tabs nav-hospital">
												 ...
												 <li class="active"><a data-toggle="tab" href="#hospital_doc" id="avoidinterrupthome1"><?php if($lghosmod18){ echo $lghosmod18; }else { ?>Add Hospital<?php } ?></a></li>
                                                                   ...
                                                                   <li data-tab="tab-man-1-hosp" class="li-m-hosp">
                                                                       <div class="col-lg-6 checkinsidehospital">
                                                                           <div class="add-new-doc">
                                                                               <h5><a href="javascript:void(0);"><?php if($lghosmod96){ echo $lghosmod96; }else { ?>Add New Hospital<?php } ?></a></h5>
                                                                           </div>
                                                                       </div>
                                                                   </li>
                                                                   <li data-tab="tab-man-2-hosp" class="li-m-hosp">
                                                                       <div class="col-lg-6">
                                                                           <div class="view-new-doc">
                                                                               <h5><a href="javascript:void(0);"><?php if($lghosmod97){ echo $lghosmod97; }else { ?>View Hospitals<?php } ?></a></h5>
                                                                           </div>
                                                                       </div>
                                                                   </li>
                                                               </ul>
                                                            ...
                                                            <div class="form-group hos-frm-grp">
                                                                <div class="col-lg-10">
																	...
																	<input type="hidden" name="terms" value="agreed" >
                                                                        <div class="col-lg-3">
                                                                            <div class="text-left-hsp">
                                                                                <h6><?php if($lghosmod20){ echo $lghosmod20; }else { ?>Hospital Name<?php } ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="1234" name="hospital_zip" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="hospital_country" class="form-control" id="exampleSelect1" onchange="selectStatedocsubcenter(this.options[this.selectedIndex].value)" required="" >
                                  ...
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select  name="hospital_state" onchange="selectCitydocsubcenter(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown_docsubcenter" required="" >
										<option selected="selected" value="-1"><?php if($lgdoctormodalso){ echo $lgdoctormodalso; }else { ?>Select state<?php } ?></option>                                 
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?></h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="hospital_city" class="form-control" id="city_dropdown_docsubcenter"  required="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                           <h4 class="ap-date-1"> <a href="<?php echo base_url(); ?>Welcome/pdf_hosp/<?php echo $current_date;?>" class="dwd"><?php if($lghosmod55){ echo $lghosmod55; }else { ?>Download<?php } ?><span><img src="<?php echo base_url(); ?>assets/images/dashboard/13.png"/> </span></a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!-----additional gallery end --------------->
            ...
            ?>
												...
												<div class="row">
												 <div class="upload-hospital">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <div class="text-left-hsp">
                                                                <h6><?php if($lghosmod70){ echo $lghosmod70; }else { ?>Hospital<?php } ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" value="<?php echo $hospital_data->phone; ?>" name="123456789" id="example" placeholder="<?php if($lghosmod74){ echo $lghosmod74; }else { echo "123456"; }?>" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="16" required =" ">
                                                        </div>
                                                    </div>
                                                   <div class="row">
                                                                        <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="hospital_country" class="form-control" id="exampleSelect1" onchange="selectStatedocsub(this.options[this.selectedIndex].value)" required="" value="<?php echo $hospital_data->hospital_country;?>">
									
									<option selected="selected" value="-1"><?php if($lgdoctormod44){ echo $lgdoctormod44; }else { ?>Select country<?php } ?></option>
                                  <?php foreach($countries as $row_country){  ?>
                             <option value="<?php echo $row_country->id;?>" <?php if($row_country->id == $hospital_data->hospital_country ){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_country->country_name;?></option>
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select  name="hospital_state" onchange="selectCitydocsub(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown_docsub" required="" value="<?php echo $hospital_data->hospital_state;?>" >
                             ...
                             <option value="<?php echo $row_state->id;?>" <?php if($row_state->id == $hospital_data->hospital_state){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_state->state_name;?></option>
                                  <?php  }   ?>                                                               
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?></h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="hospital_city" class="form-control" id="city_dropdown_docsub" value="<?php echo $hospital_data->hospital_city;?>" required="">
                             ...
                             <option value="<?php echo $row_city->id;?>" <?php if($row_city->id == $hospital_data->hospital_city ){ ?>
								selected ="selected" 
...
<h5><?php if($lghosmod36){ echo $lghosmod36; }else { ?>If your city not found . Use location settings to add your city <?php } ?></h5>
			...
			<form method="post" data-parsley-validate="" enctype="multipart/form-data">
												...
												<div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            <h4 class="h4-sub-mn"><button type="submit" name="hospital-self-check" value="
															"class="btn btn-default bfn-sve"><?php if($lghosmod94){ echo $lghosmod94; }else { ?>Save<?php } ?><span><img src="<?php echo base_url(); ?>assets/images/dashboard/15.png" /></span></button></h4>
                                                        </div>
                                                    </div>
</form>
                                                </div>

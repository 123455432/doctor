                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="sel-clinic-group">							
                                <img src= "<?php echo $view_hospital->display_image;?>" alt="" class="img-responsive sel-log-img"/>
                                <p><?php echo $view_hospital->hospital_address; ?>, <?php echo $view_hospital->city_name;?>
                                   <?php echo $view_hospital->state_name;?>,<?php echo $view_hospital->country_name;?> <?php echo $view_hospital->hospital_zip;?>
                                </p>
                                <h4>Rate Us</h4>
                                    ...
                                    <div class="manage-ad-inner-main tab-manage-1">
                                     <div class="image-large-gallery">
									  ...
									  <?php if(!empty ($view_hospitalgallery[0])){ ?>
                                          <img src= "<?php echo $view_hospitalgallery[0]->image;?>" id="DataDisplay" class="img-responsive" />
									  <?php }else{ ?>
                                                     ...
                                                     <div class="carousel-inner onebyone-carosel">
                                                         <div class="item active">
															 ...
															 <?php if(!empty ($view_hospitalgallery[1])){ ?>
                                                              <img src= "<?php echo $view_hospitalgallery[1]->image;?>" />
															   <?php }else{ ?>
									  ...
									  <?php }?>
                                                         ...
                                                         <div class="item ">
															 ...
															 <?php if(!empty ($view_hospitalgallery[2])){ ?>
                                                                 <img src= "<?php echo $view_hospitalgallery[2]->image;?>" />
																  <?php }else{ ?>
										     <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_hospitalgallery[3])){ ?>
                                                                 <img src= "<?php echo $view_hospitalgallery[3]->image;?>" />
																  <?php }else{ ?>
										    <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_hospitalgallery[4])){ ?>
                                                                 <img src= "<?php echo $view_hospitalgallery[4]->image;?>" />
																  <?php }else{ ?>
										     <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_hospitalgallery[5])){ ?>
                                                                 <img src= "<?php echo $view_hospitalgallery[5]->image;?>" />
																  <?php }else{ ?>
										     <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
                                                         ...
                                                         <div class="item">
															 ...
															 <?php if(!empty ($view_hospitalgallery[6])){ ?>
                                                                 <img src= "<?php echo $view_hospitalgallery[6]->image;?>" />
																  <?php }else{ ?>
										     <img src="<?php echo base_url(); ?>assets/images/sel-clinic/1.jpg"  />
									  <?php }?>
                                                             </div>
    ...
    <div class="modal fade bac-modal" id="myModalbook-app" role="dialog">
        ...
        <div class="view-more loadmore">
		 <div id="morehospitaldoctor<?php echo $doctor_detail->id; ?>" class="moreboxhospitaldoctor">
            ...
            <a href="#" id="<?php  echo $doctor_detail->id; ?>" class="filterloadmorehospitaldoctor" ><h3><span><img src="<?php echo base_url(); ?>assets/images/patient-login/vmore.png" /> </span><?php if($lgfncountry){ echo $lgfncountry; }else { ?>View More<?php } ?></h3></a>
        </div>
    </div>
		 <?php } ?>

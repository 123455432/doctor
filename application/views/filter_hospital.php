    ...
    <div class="container">
        <div class="row">
          ...
          <form role="form" action="" method="post"  id="form_doctor_hospital" class="form_doctor_hospital formap" enctype="multipart/form-data">
                        ...
                        <div class="row row-frm">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select   onchange="selectStatehospital(this.options[this.selectedIndex].value)" name="country" class="form-control filter-field_hospital" id="exampleSelect1" required =" " >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                   ...
                                   <select   onchange="selectCityhospital(this.options[this.selectedIndex].value)" name="state" class="form-control filter-field_hospital" id="state_dropdown" required =" " >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="exampleSelect1"><?php if($lgfncity){ echo $lgfncity; }else { ?>City<?php } ?></label>
                                     <select    name="city" class="form-control filter-field_hospital" id="city_dropdown" required =" " >
            ...
            <div class="col-lg-12">
                <div class="doctor">
                    <h4><span><img src="<?php echo base_url(); ?>assets/images/home/form-4.png" > </span><?php if($lghostdes3){ echo $lghostdes3; }else { ?>Hospitals near by You<?php } ?></h4>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="doctor-sub">
       <h3><img src="<?php echo base_url(); ?>assets/images/patient-login/12.png"  ></h3>
        <h4><?php if($lghostdes1){ echo $lghostdes1; }else { ?>Select a Hospital<?php } ?></h4>
    </div>
...
?>
		...
		<div id="morehospital<?php echo $hospital_detail->id; ?>" class="moreboxhospital">
            ...
            <a href="#" id="<?php  echo $hospital_detail->id; ?>" class="filterloadmore_hospital" ><h3><span><img src="<?php echo base_url(); ?>assets/images/patient-login/vmore.png" /> </span><?php if($lgfdviewmore){ echo $lgfdviewmore; }else { ?>View More<?php } ?></h3></a>
        </div>            
        </div>
		<?php } ?>
    </div>

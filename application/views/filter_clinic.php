    ...
    <div class="container">
        <div class="row">
          ...
          <form role="form" action="" method="post"  id="form_doctor_clinic" class="form_doctor_clinic formap" enctype="multipart/form-data">
                        ...
                        <div class="row row-frm">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select   onchange="selectState(this.options[this.selectedIndex].value)" name="country" class="form-control filter-field_clinic" id="exampleSelect1" required =" " >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                   ...
                                   <select   onchange="selectCity(this.options[this.selectedIndex].value)" name="state" class="form-control filter-field_clinic" id="state_dropdown" required =" " >
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="exampleSelect1"><?php if($lgfncity){ echo $lgfncity; }else { ?>City<?php } ?></label>
                                     <select    name="city" class="form-control filter-field_clinic" id="city_dropdown" required =" " >
            ...
            <div class="col-lg-12">
                <div class="doctor">
                    <h4><span><img src="<?php echo base_url(); ?>assets/images/home/form-2.png" > </span><?php if($lghostdes1){ echo $lghostdes1; }else { ?>Clinics near by You<?php } ?></h4>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="doctor-sub">
       <h3><img src="<?php echo base_url(); ?>assets/images/patient-login/12.png"  ></h3>
        <h4><?php if($lghostdes4){ echo $lghostdes4; }else { ?>Select a Clinic<?php } ?></h4>
    </div>
...
?>
		...
		<div id="moreclinic<?php echo $clinic_detail->id; ?>" class="moreboxclinic">
            ...
            <a href="#" id="<?php  echo $clinic_detail->id; ?>" class="filterloadmore_clinic" ><h3><span><img src="<?php echo base_url(); ?>assets/images/patient-login/vmore.png" /> </span><?php if($lgfdviewmore){ echo $lgfdviewmore; }else { ?>View More<?php } ?></h3></a>
        </div>            
        </div>
		<?php } ?>
    </div>

...
<?php $cli_id=$this->session->userdata['frontend_logged_in']['id']; ?>
        ...
        <div class="sel-clinic-main">
                ...
                <div class="col-lg-12 ">
					...
					<h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2> <?php if($lghosmod102){ echo $lghosmod102; }else { ?> You are using 15 days free trial version.Once the trial period is expired , your clinic listing will be removed from Search Filter. Select any package to extend your service under Bookmydoc.<?php } ?>
								</h2>
					</div>
					...
					<button class="close" data-dismiss="alert" type="button">×</button>
					<h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2>  <?php if($lghosmod103){ echo $lghosmod103; }else { ?>Your Package period is expired . Kindly Select any package to list your clinic under Bookmydoc.<?php } ?>
								</h2>
					</div>
								 ...
								 <div class="head-my-listing">
								 <h1><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h1>
                                            <h2> <?php if($lghosmod105){ echo $lghosmod105; }else { ?>Your clinic will found once if you complete the required details for profile settings and features.So please add it & list your clinic under BOOKMYDOC.<?php } ?>
								</h2>
                                        </div>
								<?php } ?>
                                        <div class="head-my-listing">
                                            <h3><?php if($lghosmod12){ echo $lghosmod12; }else { ?>Clinics under <?php } ?><?php echo $username; ?></h3>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                       ...
                                                       <!---<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i>-->
                                                        <div class="pt-ent">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <h6><?php echo $mysubhosp->clinic_address; ?> <?php echo $mysubhosp->city_name;?>,<?php echo $mysubhosp->state_name;?>,<?php echo $mysubhosp->country_name;?>.<?php echo $mysubhosp->clinic_zip;?></h6>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-2 evt-br-1 view-cln-1">
                                                    <div class="view-clinic view-dash-mn">
                                                        <a href="javascript:void(0);" id="<?php echo $mysubhosp->id;?>" class="hospitaljuncdoctoranotherclinic" ><h5><span><i class="fa fa-pencil"></i> </span><?php if($lghosmod14){ echo $lghosmod14; }else { ?>Edit<?php } ?></h5></a>
                                                        <h5><?php if($lghosmod15){ echo $lghosmod15; }else { ?>Published<?php } ?></h5>
                                                        <h5><?php if($lghosmod16){ echo $lghosmod16; }else { ?>Hits - 0<?php } ?></h5>
                                                        <h6><a href="javascript:void(0);" id="<?php echo $mysubhosp->id;?>" class="hospitaljuncdoctoranotherclinicdelete" > <?php if($lghosmod17){ echo $lghosmod17; }else { ?> Remove<?php } ?></a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                         <?php } ?>  
                                  ...
                                  <?php  }   ?>
                                    ...
                                    <div class="manage-ad-inner-main tab-manage-2">
                                            ...
                                            <ul class="nav nav-tabs nav-hospital">
												 ...
												 <li class="active"><a data-toggle="tab" href="#hospital_doc" id="avoidinterrupthome1"><?php if($lghosmod108){ echo $lghosmod108; }else { ?>Add Clinic<?php } ?></a></li>
                                                                   ...
                                                                   <li data-tab="tab-man-1-hosp" class="li-m-hosp">
                                                                       <div class="col-lg-6 checkinsidehospital">
                                                                           <div class="add-new-doc">
                                                                               <h5><a href="javascript:void(0);"><?php if($lghosmod110){ echo $lghosmod110; }else { ?>Add New Clinic<?php } ?></a></h5>
                                                                           </div>
                                                                       </div>
                                                                   </li>
                                                                   <li data-tab="tab-man-2-hosp" class="li-m-hosp">
                                                                       <div class="col-lg-6">
                                                                           <div class="view-new-doc">
                                                                               <h5><a href="javascript:void(0);"><?php if($lghosmod111){ echo $lghosmod111; }else { ?>View Clinics<?php } ?></a></h5>
                                                                           </div>
                                                                       </div>
                                                                   </li>
                                                               </ul>
                                                            ...
                                                            <div class="form-group hos-frm-grp">
                                                                <div class="col-lg-10">
																	...
																	<input type="hidden" name="terms" value="agreed" >
                                                                        <div class="col-lg-3">
                                                                            <div class="text-left-hsp">
                                                                                <h6><?php if($lghosmod106){ echo $lghosmod106; }else { ?>Clinic Name<?php } ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="Clinic Name" name="clinic_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " >
                                                                        </div>
                                                                    </div>
																	<div class="row">
                                                                        <div class="col-lg-3">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="1234" name="clinic_zip" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="clinic_country" class="form-control" id="exampleSelect1" onchange="selectStatedocsubcenter(this.options[this.selectedIndex].value)" required="" >
                                  ...
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select  name="clinic_state" onchange="selectCitydocsubcenter(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown_docsubcenter" required="" >
										<option selected="selected" value="-1"><?php if($lgdoctormodalso){ echo $lgdoctormodalso; }else { ?>Select state<?php } ?></option>                                 
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?> </h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="clinic_city" class="form-control" id="city_dropdown_docsubcenter"  required="">
...
<h5><?php if($lghosmod36){ echo $lghosmod36; }else { ?>If your city not found . Use location settings to add your city<?php } ?> </h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <textarea class="form-control" name="about_clinic" placeholder="" required=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="prf-rght-dash">
                                                                       <a href="javascript:void(0);"  class="hospitaljuncdoctorclinic" id="<?php echo $subhosp->id; ?>">  <i class="fa fa-pencil"></i>
                                                                        <div class="clearfix"></div>
														...
														<?php foreach ($mydoc_hospital as $mydoc_hospital_detail){ ?>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    <div class="prf-rght-dash">
                                                                        <a href="javascript:void(0);"  class="hospitaljunchospclinicdoctor" id="<?php echo $mydoc_hospital_detail->id; ?>"><i class="fa fa-pencil"></i>
                                                                        <div class="clearfix"></div>
                                                                        <h4><?php if($lghosmod39){ echo $lghosmod39; }else { ?>Edit<?php } ?></h4></a>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                           <h4 class="ap-date-1"> <a href="<?php echo base_url(); ?>Welcome/pdf_clinic/<?php echo $current_date;?>" class="dwd"><?php if($lghosmod55){ echo $lghosmod55; }else { ?>Download<?php } ?><span><img src="<?php echo base_url(); ?>assets/images/dashboard/13.png"/> </span></a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="row  "> <div class="head-my-listing">
                                            ...
                                            <h3> <?php if($lghosmod67){ echo $lghosmod67; }else { ?> Add Gallery Images<?php } ?>
                                                                     ...
                                                                     <?php foreach ($gallery_clinic_pictures as $doc_gallery){ ?>
                                                                         <div class="col-lg-3">
                                                                             <div class="form-group">
																				<button class="close forimagecloseforclinic"  id="<?php echo $doc_gallery->id; ?>" type="button">×</button>
                                                                                 <img src= "<?php echo $doc_gallery->image;?>" alt="" class="img-responsive round-mn"/>                                                                             
																			 </div>
                                                                         </div>
																	 <?php } ?>
                                                                     <form method="post" id="gallery_imagefirst_clinic" enctype="multipart/form-data">
						                                                    <input type="file" name="image" id="gallery_image1_clinic" class="custom-file-input">
																			<input type="hidden" name="hospital_id" value="<?php echo $cli_id;?>">
																			<input type="hidden" name="doctorsubmitgallery1_clinic" value="doctorsubmitgallery1_clinic" id="doctorsubmitgallery1" class="custom-file-input">
                                                                              </form>														
                                                        </div>												
                                                    </div>             
<!-----additional gallery end ---------------></div> 
            ...
            ?>
												...
												<div class="row">
												 <div class="upload-hospital">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <div class="text-left-hsp">
                                                                <h6><?php if($lghosmod106){ echo $lghosmod106; }else { ?>Clinic<?php } ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" value="<?php echo $hospital_data->clinic_website; ?>" name="clinic_website" class="form-control" placeholder="www.example.com" required =" ">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                   ...
                                                   <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="clinic_country" class="form-control" id="exampleSelect1" onchange="selectStatedocsub(this.options[this.selectedIndex].value)" required="" value="<?php echo $hospital_data->clinic_country;?>">
									
									<option selected="selected" value="-1"><?php if($lgdoctormod44){ echo $lgdoctormod44; }else { ?>Select country<?php } ?></option>
                                  <?php foreach($countries as $row_country){  ?>
                             <option value="<?php echo $row_country->id;?>" <?php if($row_country->id == $hospital_data->clinic_country ){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_country->country_name;?></option>
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select  name="clinic_state" onchange="selectCitydocsub(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown_docsub" required="" value="<?php echo $hospital_data->clinic_state;?>" >
                             ...
                             <option value="<?php echo $row_state->id;?>" <?php if($row_state->id == $hospital_data->clinic_state){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_state->state_name;?></option>
                                  <?php  }   ?>                                                               
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?> </h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="clinic_city" class="form-control" id="city_dropdown_docsub" value="<?php echo $hospital_data->clinic_city;?>" required="">
                             ...
                             <option value="<?php echo $row_city->id;?>" <?php if($row_city->id == $hospital_data->clinic_city ){ ?>
								selected ="selected" 
...
<input type="hidden" name="hospital_type" value="clinic" >

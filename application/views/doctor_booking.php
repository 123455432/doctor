                ...
                <ul class="nav nav-tabs  nav-tb tab-online">
                    ...
                    <li class="active" id="menuspatinitial">
                        <a data-toggle="tab" href="#homes">
                            ...
                            <h4><?php if($lgbookingmod1){ echo $lgbookingmod1; }else { ?>Appointment<?php } ?></h4></a>
                    </li>
                    ...
                    <li class="patdetailsbooking"><a data-toggle="tab" href="#menus1" id="menuspat1">
                            ...
                            <h4><?php if($lgbookingmodmessage3){ echo $lgbookingmodmessage3; }else { ?>Patient Details<?php } ?></h4></a>
                    </li>
                    <li><a data-toggle="tab" href="#menus2" id="menuspat2">
                            ...
                            <h4><?php if($lgbookingmodmessage4){ echo $lgbookingmodmessage4; }else { ?>Check-In Details<?php } ?></h4></a></li>
                    <li><a data-toggle="tab" href="#menus3" id="menuspat3">
                            ...
                            <h4><?php if($lgbookingmodmessage5){ echo $lgbookingmodmessage5; }else { ?> Finished<?php } ?></h4></a></li>
                </ul>
            </div>
        ...
        <div class="container-fluid tab-fluid" style="border-top:none;">
                    ...
                    <div id="homes" class="tab-pane fade in active">
                       ...
                       <div class="col-lg-offset-1 col-lg-11">
                           <div class="col-lg-6 br-patient-1">
							   ...
							   <img src= "<?php echo $book_doctor->display_image;?>" /> 
                                  <?php }else{ ?>
			...
			<?php  }?>
                               ...
                               <div class="left-events">
								 ...
								 <!---  <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i>-->
                                   ...
                                   <div class="appointment">
                                       <h4><?php if($lgbookingmod2){ echo $lgbookingmod2; }else { ?>Appointment time<?php } ?></h4>
                           ...
                           <div class="patient-info">
                               <h4><?php if($lgbookingmod3){ echo $lgbookingmod3; }else { ?>Patient Registration<?php } ?></h4>
							   ...
							   if ($this->session->userdata('frontend_logged_in'))
			                 {
							   ...
							   <div class="form-group">
                                               <label for="exampleSelect1"><?php if($lgbookingmod25){ echo $lgbookingmod25; }else { ?>Insurance<?php } ?></label>
                                               <select    name="insurance" id="insuranceapp" required="" class="form-control" id="bkinsurance"  >
										<option selected="selected" value=""><?php if($lgbookingmod26){ echo $lgbookingmod26; }else { ?>Insurance<?php } ?></option>
                             ...
                             <option value="<?php echo $row_insurance->id;?>"><?php echo $row_insurance->insurance_name;?></option>
                                  <?php  }   ?>
                                           ...
                                           <div class="form-group">
                                               <label for="exampleSelect1"><?php if($lgbookingmod27){ echo $lgbookingmod27; }else { ?>What's the reason for your visit?<?php } ?></label>
                                               <select    name="visitation" id="visitationapp" required="" class="form-control" id="bkvisitation"  >
										<option selected="selected" value=""><?php if($lgbookingmod28){ echo $lgbookingmod28; }else { ?>Visitation<?php } ?></option>
                             ...
                             <option value="<?php echo $row_visitation->id;?>"><?php echo $row_visitation->reason;?></option>
                                  <?php }   ?>
										   ...
										   <div class="form-group">
                                 <!---<h4><button type="submit"  name="formdocreg" class="btn btn-default btn-continue btn-continue-patreg">Save</button></h4>-->
                             </div>
							 </form>  <div class="pat-continue-reg">
                                 <h4><button type="submit"   class="btn btn-default btn-continue pat-continue"><?php if($lgbookingmodmessage1){ echo $lgbookingmodmessage1; }else { ?>Click Here To Continue<?php } ?></button></h4>
                             </div>
										   </div>
										 
							 <?php }else{ ?>
								 <h3><?php if($lgbookingmodmessage2){ echo $lgbookingmodmessage2; }else { ?>Please Login as patient to continue . Only patients can book appointment. <?php } ?></h3> </br>
							<?php  } }?>
										 <?php 
							   if (!$this->session->userdata('frontend_logged_in'))
			                 { ?>   
								    <div class="col-lg-8">
								<label for="exampleInputPassword1"><?php if($lgbookingmod4){ echo $lgbookingmod4; }else { ?>Check New / Existing Account<?php } ?></label>
									<div class="form-group">
									 
									 <input type="radio"  name="check" class="newdocchecker1" > <label for="exampleSelect1"><?php if($lgbookingmod5){ echo $lgbookingmod5; }else { ?>I'm New to Bookmydoc<?php } ?></label></br>
									 
									 <input type="radio"  name="check" class="newdocchecker2" > <label for="exampleSelect1"><?php if($lgbookingmod17){ echo $lgbookingmod17; }else { ?>I've used Bookmydoc Before<?php } ?></label>
									</div>
							 </div><?php } ?>
									<div class="col-lg-8">
									...
									<div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod6){ echo $lgbookingmod6; }else { ?>First Name<?php } ?></label>
                             ...
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod9){ echo $lgbookingmod9; }else { ?>Last Name<?php } ?></label>
                             ...
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod10){ echo $lgbookingmod10; }else { ?>Email<?php } ?></label>
                                 <input type="text" name="email" class="form-control" id="bkemail" data-parsley-trigger="change" data-parsley-type="email" required="">
                             </div>
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod11){ echo $lgbookingmod11; }else { ?>Create a Password<?php } ?></label>
                                 <input type="password" name="password" class="form-control" id="bkpassword" data-parsley-minlength="6" required="">
                             </div>
                         
                         
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod12){ echo $lgbookingmod12; }else { ?>Sex<?php } ?></label>
                                 <div class="radio">
                                     <label><input type="radio" value="male" name="patient_sex" id="bksex" required=""><?php if($lgbookingmod13){ echo $lgbookingmod13; }else { ?>Male<?php } ?></label>
                                 </div>
                                 <div class="radio">
                                     <label><input type="radio" id="bksex" value="female" name="patient_sex" required=""><?php if($lgbookingmod14){ echo $lgbookingmod14; }else { ?>Female<?php } ?></label>
                                 </div>
                             ...
                             <div class="form-group">                              
                                 <div class="checkbox">
                                     <label><input type="checkbox" value="agreed" id="bkterms" name="terms" required><?php if($lgbookingmod15){ echo $lgbookingmod15; }else { ?>I Agree to the Terms and Conditions<?php } ?></label>
                                 </div>
                             </div>
							 ...
							 <div class="form-group">
                              <div class="col-lg-12">
							   <label for="email"><?php if($lgbookingmod19){ echo $lgbookingmod19; }else { ?>Email<?php } ?></label>
                          ...
                          <div class="form-group">
                              <div class="col-lg-12">
							  <label for="password"><?php if($lgbookingmod20){ echo $lgbookingmod20; }else { ?>Password<?php } ?></label>
                 ...
                 <div class="forget-pass">
                    ...
                    <h4><button type="submit" name="formdocsignin"  class=" btn btn-default btn-continue log-in-a formdocsignin"><?php if($lgbookingmod22){ echo $lgbookingmod22; }else { ?>Signin to continue<?php } ?></button></h4>
                 </div>
                              </div>
                                ...
                                <div class="col-lg-6 br-pad">
                                    <div class="col-lg-12">
                                        <div class="appoin-det">
                                            <h5><?php if($lgbookingmod29){ echo $lgbookingmod29; }else { ?>Appointment Details<?php } ?></h5>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="pat-det-1">
                                                    <h4><?php if($lgbookingmod31){ echo $lgbookingmod31; }else { ?>Patiant Name<?php } ?></h4>
                                                    <h4><?php if($lgbookingmod32){ echo $lgbookingmod32; }else { ?>General Insurance<?php } ?></h4>
                                                    <h4><?php if($lgbookingmod33){ echo $lgbookingmod33; }else { ?>General Reason<?php } ?></h4>                                                    
                                                    <h4><?php if($lgbookingmod34){ echo $lgbookingmod34; }else { ?>Gender<?php } ?></h4>
                                                    <h4><?php if($lgbookingmod2){ echo $lgbookingmod2; }else { ?>Appointment Time<?php } ?></h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
									...
									<h4 id="checkvisittext"><?php if($patientinfo->visit_title != ""){ echo $patientinfo->visit_title; }else{ echo "none";}?></h4>    
                                                 ...
                                                 <h4><?php echo $cal_date;?> <?php echo $cal_time;?></h4>
											 	   ...
											 	   <div class="form-group">
                                 <h4><button type="submit" class="btn btn-default btn-continue pat-continue-reg1"><?php if($lgbookingmod41){ echo $lgbookingmod41; }else { ?>Continue<?php } ?></button></h4>
                             </div>
                                            </div>
											 <!--<h6>Above mentioned insurance and ill reason are earlier already you've stored in your profile.Your Request of insurance and ill reason will be added once if you complete the course of appointment booking.</h6>-->
                                        </div>
                                    </div>
                                </div>
                            </div>
			...
			<?php  }?>
                                ...
                                <div class="col-lg-6 br-pad ">
                                  <div class="ck-online">
                                      <h4 class="checkonline-box1" ><span><img src="<?php echo base_url(); ?>assets/images/patient-login/tck-1.png" /></span><?php if($lgbookingmod35){ echo $lgbookingmod35; }else { ?>Check in Online<?php } ?></h4>
									  
                                     
									  <button type="submit" class="btn checkonline-box2" name="formcheckdummy" value="formcheckdummy"> <h4  ><span><img src="<?php echo base_url(); ?>assets/images/patient-login/tick.png" /></span> <?php if($lgbookingmod36){ echo $lgbookingmod36; }else { ?> No Thanks<?php } ?></h4></button>
						...
						<div class="row " >
							...
							<form  role="form"  action="" id="formdocrsch" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
								...
								<input type="hidden" value="<?php echo $id;?>" id="pat_id">
										...
										<div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod6){ echo $lgbookingmod6; }else { ?>First Name<?php } ?></label>
                                 <input type="text" name="patient_firstname" value="<?php echo $patientinfo->patient_firstname;?>" class="form-control black_control" id="ufname-n" data-parsley-pattern="^[a-zA-Z\  \/]+$" placeholder="<?php if($lgbookingmod7){ echo $lgbookingmod7; }else { echo "enter firstname"; } ?>" data-parsley-minlength="3" data-parsley-maxlength="25"required =" ">
                             </div>
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod9){ echo $lgbookingmod9; }else { ?>Last Name<?php } ?></label>
                                 <input type="text" name="patient_lastname" value="<?php echo $patientinfo->patient_lastname;?>" class="form-control black_control" id="ulname-n" data-parsley-pattern="^[a-zA-Z\  \/]+$" placeholder="<?php if($lgbookingmod8){ echo $lgbookingmod8; }else { echo "enter lastname"; } ?>" data-parsley-minlength="3" data-parsley-maxlength="25"required =" ">
                             </div>
                             ...
                             <div class="form-group">
                                 <label for="exampleInputPassword1"><?php if($lgbookingmod12){ echo $lgbookingmod12; }else { ?>Sex<?php } ?></label>
                                 <div class="radio">
                                     <label><input type="radio" value="male" <?php if ($patientinfo->patient_sex == "male"){?>checked <?php } ?> name="patient_sex" id="usex-n" required=""><?php if($lgbookingmod13){ echo $lgbookingmod13; }else { ?>Male<?php } ?></label>
                                 </div>
                                 <div class="radio">
                                     <label><input type="radio" id="usex-n" <?php if ($patientinfo->patient_sex == "female"){?>checked <?php } ?> value="female" name="patient_sex" required=""><?php if($lgbookingmod14){ echo $lgbookingmod14; }else { ?>Female<?php } ?></label>
                                 </div>
                    ...
                    <h4><a href="javascript:void(0);" class=" btn btn-default btn-continue log-in-a formdocrsch btn-continue-patreg-pat"><?php if($lgbookingmod37){ echo $lgbookingmod37; }else { ?>Update & Reappointment<?php } ?></a></h4>
                 </div>
							 </div>  </div>
			...
			<?php  }?>
                                ...
                                <div class="col-lg-6 br-pad">
                                    <div class="ck-online-1">
                                      ...
                                      <a href = "<?php echo base_url(); ?>Welcome"><span><?php if($lgbookingmod39){ echo $lgbookingmod39; }else { ?>Click here<?php } ?></span> <?php if($lgbookingmod40){ echo $lgbookingmod40; }else { ?>to proceed.<?php } ?></a>

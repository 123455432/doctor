...
<div class="form-hospital-dash inhospitaladd" >
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            <div class="text-left-hsp">
                                                                                <h6><?php if($lghosmod106){ echo $lghosmod106; }else { ?>Hospital Name<?php } ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
         <input type="text" class="form-control"  placeholder="Hospital Name" value="<?php echo $singlesub_result->hospital_name; ?>" name="hospital_name" id="hospital_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " >
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="hospital_country" id="hospital_country" value="<?php echo $singlesub_result->hospital_country;?>"  class="form-control"  onchange="selectState(this.options[this.selectedIndex].value)" required="" >
                             ...
                             <option value="<?php echo $row_country->id;?>" <?php if($row_country->id == $singlesub_result->hospital_country ){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_country->country_name;?></option>
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select  name="hospital_state" name="hospital_state" value="<?php echo $singlesub_result->hospital_state;?>" onchange="selectCity(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown" required="" >
                             ...
                             <option value="<?php echo $row_state->id;?>" <?php if($row_state->id == $singlesub_result->hospital_state){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_state->state_name;?></option>
                                  <?php  }   ?>                               
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?> </h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="hospital_city" value="<?php echo $singlesub_result->hospital_city;?>" class="form-control" id="city_dropdown"  required="">
                             ...
                             <option value="<?php echo $row_city->id;?>" <?php if($row_city->id == $singlesub_result->hospital_city ){ ?>
								selected ="selected" 

...
<div class="form-hospital-dash inhospitaladd" >
         ...
         <input type="text" class="form-control"  placeholder="Hospital Name" value="<?php echo $singlesub_result->clinic_name; ?>" name="clinic_name" id="clinic_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" ">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select name="clinic_country" id="clinic_country" value="<?php echo $singlesub_result->clinic_country;?>"  class="form-control"  onchange="selectState(this.options[this.selectedIndex].value)" required="" >
                             ...
                             <option value="<?php echo $row_country->id;?>" <?php if($row_country->id == $singlesub_result->clinic_country ){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_country->country_name;?></option>
                                  <?php  }   ?>
									  ...
									  <h5><?php if($lghosmod35){ echo $lghosmod35; }else { ?>If your country not found .Use location settings to add your country<?php } ?></h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <select   name="clinic_state" value="<?php echo $singlesub_result->clinic_state;?>" onchange="selectCity(this.options[this.selectedIndex].value)" class="form-control" id="state_dropdown" required="" >
                             ...
                             <option value="<?php echo $row_state->id;?>" <?php if($row_state->id == $singlesub_result->clinic_state){ ?>
								selected ="selected" 
							<?php } ?>><?php echo $row_state->state_name;?></option>
                                  <?php  }   ?>                               
											...
											<h5><?php if($lghosmod34){ echo $lghosmod34; }else { ?>If your state not found Use location settings to add your state <?php } ?></h5>						
																	 ...
																	 <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                           <select    name="clinic_city" value="<?php echo $singlesub_result->clinic_city;?>" class="form-control" id="city_dropdown"  required="">
                             ...
                             <option value="<?php echo $row_city->id;?>" <?php if($row_city->id == $singlesub_result->clinic_city ){ ?>
								selected ="selected" 
